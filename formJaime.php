    ...
    <div class="home-banner portfolio">
        <div class="left-text">
            <div class="d-flex flex-column">
                <div class="big-text"><p>devis</p></div>
                <div class="text-para">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="prenom" class="form-control" type="text" name=""
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input id="nomCompagnie" class="form-control" type="text" name=""
                                   placeholder="Entrer le nom de votre compagnie">
                        </div>
                    </div>
                </div>

                <a href="jaime.html" class="btn btn-primary">Envoyer</a>
            </form>
